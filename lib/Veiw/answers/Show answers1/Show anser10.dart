...
class PageWithContainers10 extends StatefulWidget {
  @override
  _PageWithContainers10State createState() => _PageWithContainers10State();
}

class _PageWithContainers10State extends State<PageWithContainers10> {
  String? selectedText;
            ...
            MaterialButtoN(
              ontape: () {
                ...
                Future.delayed(const Duration(milliseconds: 1000), () {
                  Get.offAll(ResultsPage(previousPage: 'PageWithContainers10'));
                });
              },
              text: "موافق",
            )
